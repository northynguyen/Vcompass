...
OperatingHoursEditor.propTypes = {
    operatingHours: PropTypes.array.isRequired,
    onOperatingHourChange: PropTypes.func.isRequired,
    onAddOperatingHour: PropTypes.func.isRequired,
    onRemoveOperatingHour: PropTypes.func.isRequired,
};
